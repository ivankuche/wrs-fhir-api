 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \XmlResponse\XmlResponseServiceProvider::boot()
         * @param mixed $value
         * @param mixed $status
         * @param mixed $config
         * @static 
         */ 
        public static function xml($value, $status = 200, $config = [])
        {
                        return \Illuminate\Routing\ResponseFactory::xml($value, $status, $config);
        }
...
')
     ...
     */ 
        ...
        {
                        /** @var \XmlResponse\XmlResponse $instance */
                        return $instance->app();
        }
                    /**
         * 
         ...
         * @static 
         */ 
        public static function array2xml($array, $xml = false, $config = [], $status = 200)
        {
                        /** @var \XmlResponse\XmlResponse $instance */
                        return $instance->array2xml($array, $xml, $config, $status);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function asXml($array = [], $config = [])
        {
                        /** @var \XmlResponse\XmlResponse $instance */
                        return $instance->asXml($array, $config);
        }
...
namespace  { 
            ...
            class Xml extends \XmlResponse\Facades\XmlFacade {}
